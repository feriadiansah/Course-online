                    ...
                    ->schema([
                        ...
                        ->relationship('benefits')
                            ->schema([
                                ...
                                // ini tambahan aja ketika klik tambah benefit itu akan masuk benefit untuk course apa
                            ->addActionLabel(function (callable $get) {
                                $courseName = $get('name'); // ambil value dari input 'name'
                                return $courseName
                                    ? "Add benefit to course {$courseName}"
                                    : "Add benefit";
                            }),
